...
My contribution focused on parameter tuning, bug fixing, and the complete development of the tabella.py script for automated evaluation and comparison of both algorithms. The goal was to identify when the metaheuristic outperforms BIG, given its higher computational cost.
